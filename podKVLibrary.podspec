...
Pod::Spec.new do |s|
  s.name             = 'podKVLibrary'
  s.version          = '0.1.0'
  s.summary          = 'A short description of podKVLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/qinzixin/podKVLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'qinzixin' => 'qinzixin@fengbangleasing.com' }
  s.source           = { :git => 'https://github.com/qinzixin/podKVLibrary.git', :tag => s.version.to_s }
